...
<p className={`${styles.paragraph} mt-4 mx-w-[310px]`}>A new way</p>
...
<div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3f3r45]">
 ...
 <p className="font-poppins tex-center font-normal text-[18px] text-white leading-[27px]">2021 HooBank. All Rights Reserved.</p>
